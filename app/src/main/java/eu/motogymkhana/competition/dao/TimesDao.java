...
public interface TimesDao extends Dao<Times, Integer> {
    ...
    Times getTimesForRiderForDate(int riderId, long date, Country country, int season) throws SQLException;

    List<Rider> getRegisteredRiders(long date) throws SQLException;

    List<Times> getTimesForDateAndBib(long date, Bib bib) throws SQLException;
