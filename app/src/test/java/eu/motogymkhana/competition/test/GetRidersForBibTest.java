...
public class GetRidersForBibTest {
    ...
    @Test
    public void testGetRidersForBib() throws SQLException {
        ...
        List<Rider> riders = timesDao.getRegisteredRiders(round.getDate(), Bib.Y);

        Assert.assertEquals(2, riders.size());
        List<Rider> blueRiders = timesDao.getRegisteredRiders(round.getDate(), Bib.B);

        Assert.assertEquals(0, blueRiders.size());
    }
}
